        ...
        [
            ...
            Field("about_section2_body", "Second section text", type="textarea", rows=8,
                  default="GoGo Taxi is an online platform. It puts you in touch with "
                          ...
                          "rather than an automatic step. Before that approval we ask for "
                          "their driving licence and identification and look at them "
                          "ourselves, and the date of that check is recorded against the "
                          "account and shown on their profile. Every car is checked before it "
